...
public class PerfilFragment extends Fragment {
    ...
    private void openDialog() {
        ...
        imageViewclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Toast.makeText(PerfilFragment.this.getContext(), "Cerrado", Toast.LENGTH_SHORT).show();
            }
        });
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Nombre.getText().toString().isEmpty() || Email.getText().toString().isEmpty() || Phone.getText().toString().isEmpty()){
                    Toast.makeText(PerfilFragment.this.getContext(), "Uno o varios campos estan vacios.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                user.updateEmail(email).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        docRef.update(edited).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(PerfilFragment.this.getContext(), "Perfil actualizado", Toast.LENGTH_SHORT).show();
                                //onBackPressed();
                                dialog.dismiss();
                                return;
                            }
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(PerfilFragment.this.getContext(),   e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        btnno.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.cancel();
                Toast.makeText(PerfilFragment.this.getContext(), "Cancelado", Toast.LENGTH_SHORT).show();
            }
        });
        dialog.show();
